package com.nurmiati.tok_ko.core.data.source

import com.nurmiati.tok_ko.core.data.model.ResponsModel
import com.nurmiati.tok_ko.core.data.model.Checkout
import com.nurmiati.tok_ko.core.data.model.rajaongkir.ResponsOngkir
...
interface ApiService {
    ...
    @GET("produk/bykategori/{kategori_id}")
    fun produkIdKategori(
        @Path("kategori_id") kategori_id: Int
    ): Call<ResponsModel>
